...
export const metadata: Metadata = {
  title: `Best AI Logo Generators in 2026 — ${PRODUCT_CONFIG.name}`,
  description:
    "Compare the best AI logo generators in 2026. Free tools, startup-friendly pricing, and no-design-skills-needed options reviewed side by side.",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              ...
              <p className="text-xl text-text-secondary leading-relaxed max-w-3xl">
                Side-by-side reviews of the top AI logo tools — from free
                generators to startup-grade brand kits. Find the right fit for
            ...
            <section className="text-center py-12 px-8 rounded-2xl bg-surface-secondary border border-white/5">
              ...
              <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
                Start generating professional logos in seconds. Free to try, no
