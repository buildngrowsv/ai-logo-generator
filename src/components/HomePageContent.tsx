...
export default function HomePageContent() {
  ...
  /* FAQPage JSON-LD removed — provided by page.tsx (Server Component) for SSR visibility.
     Duplicate JSON-LD in client components causes Google "duplicate field" warnings. */
