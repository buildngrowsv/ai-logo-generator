...
const REQUIRED_VARS = [
  ...
  { name: "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY", description: "Stripe publishable key (pk_live_* or pk_test_*)" },
  { name: "STRIPE_WEBHOOK_SECRET", description: "Stripe webhook signing secret (whsec_*)" },
  { name: "NEXT_PUBLIC_STRIPE_PRICE_BASIC_MONTHLY", description: "Stripe price ID for Basic monthly tier" },
  { name: "NEXT_PUBLIC_STRIPE_PRICE_PRO_MONTHLY", description: "Stripe price ID for Pro monthly tier" },
