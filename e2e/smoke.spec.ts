/**
 * e2e/smoke.spec.ts — LogoForge AI (AI Logo Generator) smoke tests
 *
 * PURPOSE:
 ...
 *
 * SCOPE:
 *   - Homepage renders product branding (LogoForge AI)
 ...
 *   E2E_BASE_URL=https://generateailogo.com npx playwright test e2e/smoke.spec.ts
 */
...
test.describe("EN homepage", () => {
  ...
  test("page title contains product name", async ({ page }) => {
    ...
    expect(title.toLowerCase()).toMatch(/logoforge|logo generator|logo/i);
  });
